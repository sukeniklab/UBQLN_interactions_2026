...
alignment = AlignIO.read("STI1-2_aligned.fasta", "fasta")
...
sns.heatmap(matrix, cmap="Oranges", square=True, 
...
# Hide the grid lines in the masked upper triangle
...
plt.savefig("Fig_SI10b.svg", dpi=300, bbox_inches='tight')
plt.close()
